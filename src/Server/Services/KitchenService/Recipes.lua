...
-- 	Steps:
	-- 1. Ice 
	-- 2. Water (Soft Drink Machine)
		Player:SetAttribute("BackpackEnabled", false)
		KitchenService:_getCup(Player)
			:andThen(function()
				task.wait(1)
				return KitchenService:_getIce(Player)
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_getDrink(Player, "Water")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_submitItem(Player, "Spring Water"):andThen(function()
	...
	-- Steps:
		...
		KitchenService:_getCup(Player)
			...
			:andThen(function()
				task.wait(1)
				return KitchenService:_getDrinkIngredient(Player, "Watermelon")
			end)
			:andThen(function()
				task.wait(1)
			...
			:andThen(function()
				task.wait(1)
				return KitchenService:_mixDrink(Player, "Hwachae")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_getDrinkIngredient(Player, "Mint")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_submitItem(Player, "Hwachae"):andThen(function()
					Player:SetAttribute("BackpackEnabled", true)
				end)
			end)
...
-- 		Steps:
		-- 1. Ice
		-- 2. Lemonade (Soft Drink Machine)
		-- 3. Cider (Soft Drink Machine)
		-- 4. Watermelon (Fridge)
		Player:SetAttribute("BackpackEnabled", false)
		KitchenService:_getCup(Player)
			:andThen(function()
			...
			:andThen(function()
				task.wait(1)
				return KitchenService:_getDrink(Player, "Lemonade")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_getDrink(Player, "Cider")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_getDrinkIngredient(Player, "Watermelon")
			...
			:andThen(function()
				task.wait(1)
				return KitchenService:_submitItem(Player, "Watermelon Ade"):andThen(function()
					Player:SetAttribute("BackpackEnabled", true)
				end)
			end)
	end,
...
-- 		Steps: 
		...
		KitchenService:_getCup(Player)
			...
			:andThen(function()
				task.wait(1)
				return KitchenService:_getDrinkIngredient(Player, "Lemon")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_submitItem(Player, "Lemonade"):andThen(function()
					Player:SetAttribute("BackpackEnabled", true)
				end)
			end)
...
-- 		Steps:
		...
		KitchenService:_getCup(Player)
			...
			:andThen(function()
				task.wait(1)
				return KitchenService:_submitItem(Player, "Pink Lemonade"):andThen(function()
					Player:SetAttribute("BackpackEnabled", true)
				end)
			end)
...
-- 		Steps:
		-- 1. Ice 
		-- 2. Orange Soda (Soft Drink Machine)
		-- 3. Orange (Fridge)
		-- 4. Lemon (Fridge)
		...
		KitchenService:_getCup(Player)
			...
			:andThen(function()
				task.wait(1)
				return KitchenService:_getDrink(Player, "Orange Soda")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_getDrinkIngredient(Player, "Orange")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_getDrinkIngredient(Player, "Lemon")
			...
			:andThen(function()
				task.wait(1)
				return KitchenService:_submitItem(Player, "Orange Sunrise"):andThen(function()
					Player:SetAttribute("BackpackEnabled", true)
				end)
			end)
	end,
	["Dalgona Coffee"] = function(Player: Player)
		...
		KitchenService:_getCup(Player)
			...
			:andThen(function()
				task.wait(1)
				return KitchenService:_getCoffee(Player)
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_boilItem(Player, "Dalgona Coffee")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_getDrinkIngredient(Player, "Milk")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_submitItem(Player, "Dalgona Coffee"):andThen(function()
					Player:SetAttribute("BackpackEnabled", true)
				end)
			end)
...
-- 		Steps:
		...
		KitchenService:_getCup(Player)
			...
			:andThen(function()
				task.wait(1)
				return KitchenService:_getStorageItem(Player, "Matcha Powder")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_getCoffee(Player)
			...
			:andThen(function()
				task.wait(1)
				return KitchenService:_mixDrink(Player, "Jeju Matcha Latte")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_submitItem(Player, "Jeju Matcha Latte"):andThen(function()
					Player:SetAttribute("BackpackEnabled", true)
				end)
			end)
	end,
...
-- 		Steps:
		...
		KitchenService:_getCup(Player)
			:andThen(function()
				task.wait(1)
				return KitchenService:_getDrinkIngredient(Player, "Corn Silk")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_getDrinkIngredient(Player, "Corn")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_boilItem(Player, "Oksusucha")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_submitItem(Player, "Oksusucha"):andThen(function()
					Player:SetAttribute("BackpackEnabled", true)
				end)
			end)
...
-- 		Steps:
		...
		KitchenService:_getCup(Player)
			:andThen(function()
				task.wait(1)
				return KitchenService:_getDrinkIngredient(Player, "Barley Leaves")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_boilItem(Player, "Boricha")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_submitItem(Player, "Boricha"):andThen(function()
					Player:SetAttribute("BackpackEnabled", true)
				end)
			end)
...
-- 		Steps:
		-- 1. Ice
		-- 2. Mixed Berries (Fridge)
		-- 3. Omija Leaves (Fridge)
		-- 4. Cider (Soft Drink Machine)
		...
		KitchenService:_getCup(Player)
			...
			:andThen(function()
				task.wait(1)
				return KitchenService:_getDrinkIngredient(Player, "Mixed Berries")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_getDrinkIngredient(Player, "Omija Leaves")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_getDrink(Player, "Cider")
			...
			:andThen(function()
				task.wait(1)
				return KitchenService:_submitItem(Player, "Omijacha"):andThen(function()
					Player:SetAttribute("BackpackEnabled", true)
				end)
			end)
	end,
