...
-- 		Steps:
	...
	-- Desserts
	["Hotteok"] = function(Player: Player)
		Player:SetAttribute("BackpackEnabled", false)
		KitchenService:_getPlate(Player)
			:andThen(function()
				task.wait(1)
			...
			:andThen(function()
				task.wait(1)
				return KitchenService:_getStorageItem(Player, "Yeast")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_getFridgeIngredient(Player, "Butter")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_getStorageItem(Player, "Cinnamon")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_rollItem(Player, "Hotteok")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_fryItem(Player, "Hotteok")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_submitItem(Player, "Hotteok"):andThen(function()
					Player:SetAttribute("BackpackEnabled", true)
				end)
			end)
	end,
	["Bungeoppang"] = function(Player: Player)
		Player:SetAttribute("BackpackEnabled", false)
		KitchenService:_getPlate(Player)
			:andThen(function()
				task.wait(1)
				return KitchenService:_getFridgeIngredient(Player, "Bungeoppang")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_getFridgeIngredient(Player, "Batter")
			...
			:andThen(function()
				task.wait(1)
				return KitchenService:_getFridgeIngredient(Player, "Red Beans")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_makeWaffle(Player)
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_submitItem(Player, "Hotteok"):andThen(function()
	...
	["Red Bean Bingsu"] = function(Player: Player)
		Player:SetAttribute("BackpackEnabled", false)
		KitchenService:_getBowl(Player)
			:andThen(function()
				task.wait(1)
				return KitchenService:_getFridgeIngredient(Player, "Ice")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_getFridgeIngredient(Player, "Red Beans")
			...
			:andThen(function()
				task.wait(1)
				return KitchenService:_getStorageItem(Player, "Condensed Milk")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_submitItem(Player, "Bingsu"):andThen(function()
					Player:SetAttribute("BackpackEnabled", true)
				end)
			end)
	end,
	["Jeju Matcha Bingsu"] = function(Player: Player)
		Player:SetAttribute("BackpackEnabled", false)
		KitchenService:_getBowl(Player)
			:andThen(function()
				task.wait(1)
			...
			:andThen(function()
				task.wait(1)
				return KitchenService:_getStorageItem(Player, "Red Beans")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_getStorageItem(Player, "Matcha Powder")
			...
			:andThen(function()
				task.wait(1)
				return KitchenService:_getFridgeIngredient(Player, "Matcha Ice Cream")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_submitItem(Player, "Bingsu"):andThen(function()
	...
	["Strawberry Bingsu"] = function(Player: Player)
		Player:SetAttribute("BackpackEnabled", false)
		KitchenService:_getBowl(Player)
			:andThen(function()
				task.wait(1)
			...
			:andThen(function()
				task.wait(1)
				return KitchenService:_getFridgeIngredient(Player, "Strawberry")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_getStorageItem(Player, "Condensed Milk")
	...
	["Classic Tanghulu"] = function(Player: Player)
		Player:SetAttribute("BackpackEnabled", false)
		KitchenService:_getStorageItem(Player, "Skewer")
			:andThen(function()
				task.wait(1)
				return KitchenService:_getFridgeIngredient(Player, "Strawberry")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_getFridgeIngredient(Player, "Tangerine")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_getFridgeIngredient(Player, "Kiwi")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_getStorageItem(Player, "Sugar")
			...
			:andThen(function()
				task.wait(1)
				return KitchenService:_fryItem(Player, "Tanghulu")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_submitItem(Player, "Tanghulu"):andThen(function()
					Player:SetAttribute("BackpackEnabled", true)
				end)
			end)
	end,
	["Shine Muscat Tanghulu"] = function(Player: Player)
		Player:SetAttribute("BackpackEnabled", false)
		KitchenService:_getStorageItem(Player, "Skewer")
			:andThen(function()
				task.wait(1)
				return KitchenService:_getFridgeIngredient(Player, "Muscat Grape")
			end)
			:andThen(function()
				task.wait(1)
				return KitchenService:_getStorageItem(Player, "Sugar")
