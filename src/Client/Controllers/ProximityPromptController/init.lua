...
--[[ 
	A table that maps gamepad button key codes to their corresponding image asset paths.
	This is used to display the correct button images in the UI for gamepad controls.

	@table GamepadButtonImage
	@within ProximityPromptController
	@field [Enum.KeyCode.ButtonX] string The image path for the Xbox X button.
	@field [Enum.KeyCode.ButtonY] string The image path for the Xbox Y button.
	@field [Enum.KeyCode.ButtonA] string The image path for the Xbox A button.
	@field [Enum.KeyCode.ButtonB] string The image path for the Xbox B button.
	@field [Enum.KeyCode.DPadLeft] string The image path for the D-Pad left button.
	@field [Enum.KeyCode.DPadRight] string The image path for the D-Pad right button.
	@field [Enum.KeyCode.DPadUp] string The image path for the D-Pad up button.
	@field [Enum.KeyCode.DPadDown] string The image path for the D-Pad down button.
	@field [Enum.KeyCode.ButtonSelect] string The image path for the Xbox menu button.
	@field [Enum.KeyCode.ButtonL1] string The image path for the Xbox left shoulder button.
	@field [Enum.KeyCode.ButtonR1] string The image path for the Xbox right shoulder button.
]]
...
--[[
	A table that maps specific keyboard keys to their corresponding image asset paths.
	This is used to display the correct image for each key in the UI.

	@table KeyboardButtonImage
	@within ProximityPromptController
]]
...
--[[
	Maps keyboard button symbols to their corresponding icon asset paths.
	This table is used to display the correct icon for specific keyboard buttons in the UI.

	@table KeyboardButtonIconMapping
	@within ProximityPromptController
]]
...
--[[
	Maps specific Enum.KeyCode values to their corresponding text representations.
	This table is used to convert key codes to user-friendly text for display purposes.

	@table KeyCodeToTextMapping
	@within ProximityPromptController
]]
...
-- Client Functions
--[[
	Initializes the ProximityPromptController and sets up the proximity prompt UI.
	...
	@local
	@function setUpCircularProgressBar
	Sets up the circular progress bar for the proximity prompt.

	@local
	@function createPrompt
	Creates and configures the proximity prompt UI elements and their animations.

	@local
	@function setupUIStrokeTweens
	Configures tweens for UIStroke elements.

	@local
	@function setupGUIObjectTweens
	Configures tweens for GuiObject elements.

	@local
	@function setupTextLabelTweens
	Configures tweens for TextLabel elements.

	@local
	@function setupImageLabelTweens
	Configures tweens for ImageLabel elements.

	@local
	@function setupUnexpectedChildTweens
	Recursively configures tweens for unexpected child elements.

	@local
	@function setupButtonFrameTweens
	Configures tweens for the button frame.

	@local
	@function setupButtonTextTweens
	Configures tweens for the button text.

	@local
	@function setupButtonImageTweens
	Configures tweens for the button image.

	@local
	@function setupIconTweens
	Configures tweens for the icon.

	@local
	@function updateUIFromPrompt
	Updates the UI elements based on the prompt's properties.

	@local
	@function cleanup
	Cleans up connections and UI elements when the prompt is hidden.

	@local
	@function onLoad
	Sets up the connection to handle prompt display and cleanup.
]]
...
local function createPrompt(prompt, inputType, gui)
	...
	local function setupButtonImageTweens()
		...
		if UserInputService.TouchEnabled and not UserInputService.KeyboardEnabled then
			table.insert(tweensForFadeIn, TweenService:Create(buttonImage, tweenInfoQuick, { ImageTransparency = 0, BackgroundTransparency = buttonImageBackgroundTransparency }))
		else
