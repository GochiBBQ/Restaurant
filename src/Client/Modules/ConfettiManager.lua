...
local Static = svcReplicatedStorage:WaitForChild("Static")

-- Confetti Defaults.
local shapes = {Static:WaitForChild("CircularConfetti"), Static:WaitForChild("SquareConfetti")};
local colors = {Color3.fromRGB(196, 255, 171), Color3.fromRGB(85, 170, 255), Color3.fromRGB(255, 255, 127), Color3.fromRGB(255, 130, 130), Color3.fromRGB(170, 170, 255)};
-- Module.
