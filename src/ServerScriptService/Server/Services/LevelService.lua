...
-- ︵‿︵‿︵‿︵︵‿︵‿︵‿︵︵‿︵‿︵‿︵︵‿︵‿︵‿︵︵‿︵‿︵‿︵︵‿︵‿︵‿︵︵‿︵‿︵‿︵︵‿︵‿
-- Server Functions
function LevelService:GetLevel(Player: Player)
	if Knit.Profiles[Player] then
		local Profile = Knit.Profiles[Player]

		if Profile.Data.Level == nil then Profile.Data.Level = 0 end
...
function LevelService:ChangeLevel(Player: Player, Increment: number, Value: number)
    if Knit.Profiles[Player] then
        local Profile
	end
end
